...
namespace CITRIS_Screen_Selector_Drag_and_Drop
{
    public partial class ScreenSelector : Form
    {
        ...
        public ScreenSelector()
        {
            ...
            // initialize outputs
            InitializeLabel(tv1_display, LabelType.OUTPUT, 2, "No Output", output_highlight);
            InitializeLabel(tv2_display, LabelType.OUTPUT, 3, "No Output", output_highlight);
            InitializeLabel(podium, LabelType.OUTPUT, 1, "No Output", output_highlight);
            InitializeLabel(polycom_out, LabelType.OUTPUT, 4, "No Output", output_highlight);
            InitializeLabel(x_proj1, LabelType.OUTPUT, 2, "No Output", output_highlight);
            InitializeLabel(x_proj2, LabelType.OUTPUT, 3, "No Output", output_highlight);
            InitializeLabel(close_podium, LabelType.OUTPUT, 1, "No Output", output_highlight);
            InitializeLabel(x_proj3, LabelType.OUTPUT, 4, "No Output", output_highlight);
            

            // initialize inputs
            InitializeLabel(laptop, LabelType.INPUT, 4, "", laptop_highlight);
            InitializeLabel(desktop1, LabelType.INPUT, 2, "", desktop1_highlight);
            InitializeLabel(desktop2, LabelType.INPUT, 3, "", desktop2_highlight);
            InitializeLabel(polycom_in, LabelType.INPUT, 6, "", doccam_highlight);
            InitializeLabel(doccam, LabelType.INPUT, 5, "", doccam_highlight);
        ...
        private void output_MouseClick(object sender, EventArgs e)
        {
            ...
            SendCommand(String.Format("SBI07O0{0}", cur_tag.GetIndex).Trim());        //VGA
